...
# Other Variables
TargetDirectory = '/usr/sshcommand/'
TIMESTAMP = STARTTIME + " " + ENDTIME
# FIle is generated in folder --- 2020-10-12_04.00.00_to_2020-10-13_08.00.00 
FOLDERNAME = starttime.strftime("%Y-%m-%d_%H.%M.%S")  + "_to_" + endtime.strftime("%Y-%m-%d_%H.%M.%S") 

# Commands
cornjobComamnd = "/usr/local/pgngn/admin-tool-4.292.0.1/bin/proclog-admin-tool.sh -et " + '"' + TIMESTAMP + '"' + " -p " + TargetDirectory
cdCommand = TargetDirectory + FOLDERNAME
...
print('Script ran succesfully. Closing Connection. \nPlease check paramiko_MML log file.')
